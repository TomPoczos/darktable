...
static const _bw_filter_preset_t _bw_filter_presets[] = {
  ...
  { N_("Wratten 15 deep yellow"),        40.9f, 0.353f },
  ...
  { N_("Wratten 32 magenta"),           291.0f, 0.325f },
  { N_("Wratten 33 strong magenta"),    341.8f, 0.446f },
  { N_("Wratten 34A violet"),           252.3f, 0.485f },
  { N_("Wratten 38A blue"),             218.5f, 0.340f },
  { N_("Wratten 39 blue glass"),        243.5f, 0.594f },
  { N_("Wratten 44 light cyan"),        190.4f, 0.326f },
  { N_("Wratten 44A minus red"),        206.0f, 0.346f },
  { N_("Wratten 47 blue"),              239.8f, 0.566f },
  ...
  { N_("Wratten 80A blue"),             227.1f, 0.214f },
  ...
  { N_("Wratten 90 monochrome viewing"), 32.4f, 0.376f },
